...
class farmers_page extends StatefulWidget {
  var data;
  farmers_page({super.key, required this.data});
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Container(child: Text(widget.data.advices[index])),
                  ),
                ),
              ],
            );
          },
          itemCount: widget.data.advices.length,
        ),
      )
    ]));
  }
